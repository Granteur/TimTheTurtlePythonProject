...
#this will cause the turtle to change directions by picking a number randomly from the cardinal directions list
    tim.setheading(random.choice(cardinal_directions))"""
